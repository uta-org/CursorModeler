EDGE crystal cursor set by eFOX

How to install
1. Extract the archive to a temporary folder.
2. Right click the "EDGE crystal . vibro/roto-work.inf" file and click on "Install".
3. Choose the cursor set in the control panel mouse applet. It appears as "EDGE crystal vibro/roto".
